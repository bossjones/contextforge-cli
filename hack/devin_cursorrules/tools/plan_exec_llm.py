...
STATUS_FILE = 'multi-agent-scratchpad.md'
...
"""
    ...
    combined_prompt += """\nYour response should be focusing on revising the Multi-Agent Scratchpad section in the @multi-agent-scratchpad.md file. There is no need to regenerate the entire document. You can use the following format to prompt how to revise the document:

<text in the original document>

<Proprosed changes>

We will do the actual changes in the @multi-agent-scratchpad.md file.
"""
...
def main():
    ...
    if response:
        print('Following is the instruction on how to revise the Multi-Agent Scratchpad section in @multi-agent-scratchpad.md:')
        print('========================================================')
        print(response)
        print('========================================================')
        print('Now please do the actual changes in the @multi-agent-scratchpad.md file. And then switch to the executor role, and read the content of the file to decide what to do next.')
    else:

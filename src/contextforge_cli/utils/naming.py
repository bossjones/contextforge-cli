...
from contextforge_cli.utils.misc import formatdoc
...
def magic_name(value, *, path_prefix):
    ...
    try:
        ...
        # https://github.com/contextforge_cli/contextforge_cli/pull/1635
        if inspect.isframe(frame):
            frame = frame.f_back

        # Iterate frames while filename starts with path_prefix (part of contextforge_cli)
